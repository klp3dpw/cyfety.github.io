...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 04, 2021 at 01:19 PM
...
-- Error reading data for table cyfety.kontak: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `cyfety`.`kontak`' at line 1
...
(1, 'coba', 'beritahu dan lapor ke sekolah pelaku'),
(2, 'test test', 'on'),
(3, '1111', 'moon'),
(4, 'Ceritakan', 'dll'),
(5, 'test', ''),
...
(10, '', ''),
(11, 'coba coba', ''),
(12, '', 'beritahu dan lapor ke sekolah pelaku,'),
(13, 'check', 'beritahu dan lapor ke sekolah pelaku,hapus status atau komentar yang berkaitan,'),
(14, '', 'coba'),
(15, '', 'beritahu dan lapor ke sekolah pelaku,on,coba'),
(16, '', 'hapus status atau komentar yang berkaitan,on,cek'),
(17, '', 'beritahu dan lapor ke sekolah pelaku,,dasda'),
(18, '', 'beritahu dan lapor ke sekolah pelaku,on,lainnya');
